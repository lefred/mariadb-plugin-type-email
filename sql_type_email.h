#ifndef SQL_TYPE_EMAIL_INCLUDED
#define SQL_TYPE_EMAIL_INCLUDED
...
class Type_handler_email: public Type_handler_long_blob
{
public:
  static constexpr LEX_CSTRING name_on_client{STRING_WITH_LEN("email")};
...
extern Type_handler_email type_handler_email;

class Type_collection_email: public Type_collection
{
public:
...
class Field_email :public Field_blob
{
public:
  Field_email(uchar *ptr_arg, uchar *null_ptr_arg, uchar null_bit_arg,
  ...
  void make_send_field(Send_field *to) override
  {
    ...
    to->set_data_type_name(Type_handler_email::name_on_client);
  }
...
class Item_email_typecast :public Item_char_typecast
{
public:
  Item_email_typecast(THD *thd, Item *a, CHARSET_INFO *cs_arg):
  ...
  {
    static LEX_CSTRING name= {STRING_WITH_LEN("cast_as_email")};
    return name;
  }
  bool fix_length_and_dec(THD *thd) override;
  String *val_str(String *to) override;
  Item *shallow_copy(THD *thd) const override
  { return get_item_copy<Item_email_typecast>(thd, this); }

  void print(String *str, enum_query_type query_type) override;
};

#endif // SQL_TYPE_EMAIL_INCLUDED
